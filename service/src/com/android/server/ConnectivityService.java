...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private void handleSetUidsAllowedTransports(@NonNull final int[] uids,
        ...
        log("transports("
                + (allowedTransportsPacked != null ? allowedTransportsPacked.length : "null")
                + "): " + allowedTransportsPacked);
    ...
    private void updateUidsAllowedTransports() {
        final Bundle allowedTransportsBundle = mPolicyManager.getUidsAllowedTransports();
