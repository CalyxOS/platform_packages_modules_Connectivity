...
//        }
    ...
    private void applyNetworkReassignment(@NonNull final NetworkReassignment changes,
        ...
        if (!affectedUids.isEmpty()) {
            ...
            logw("applyNetworkReassignment: clearRestrictedModeAllowlistForUids start");
            mPolicyManager.clearRestrictedModeAllowlistForUids(toUidRangesBundle(affectedUids));
            logw("applyNetworkReassignment: clearRestrictedModeAllowlistForUids complete");
        }
        ...
        if (!affectedUids.isEmpty()) {
            logw("applyNetworkReassignment: updateRestrictedModeAllowlistForUids start");
            mPolicyManager.updateRestrictedModeAllowlistForUids(toUidRangesBundle(affectedUids));
            logw("applyNetworkReassignment: updateRestrictedModeAllowlistForUids complete");
